...
export default {
 computed: { ...mapGetters(['cartItemList', 'isLoggedIn', 'products', 'currentUser']), totalValue() { let res = 0; this.cartItemList.map(item => { res += item.price * item.quantity; }); return res; } 
	},
  components: {
